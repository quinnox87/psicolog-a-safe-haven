    ...
    return (
        <div className="animate-fade-in min-h-screen bg-[#f6f7f7] store-page pb-20">
            ...
            <div className="max-w-7xl mx-auto px-6 space-y-20 mt-16">
                ...
                {/* Cross-Link Banner */}
                <div className="bg-gradient-to-r from-primary/5 to-primary/10 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-6 border border-primary/20">
